...
public class SF_mode extends Scene {
	...
	GridPane GPaneGif_1,GPaneGif_2,GPaneGif_3,GPaneGif_4,GPaneGif_5;
	BorderPane BPane1;
	...
	// MODE OF OPERATION
	ImageView imageView = new ImageView(new Image("IMG/MODE_OPF.png"));
	...
	ImageView imageViewR = new ImageView(new Image("IMG/btnRefresh.png"));
	ImageView imageViewC = new ImageView(new Image("IMG/btnCali.png"));
	ImageView imageViewB = new ImageView(new Image("IMG/btnBuzz.png"));
	ImageView imageViewRP = new ImageView(new Image("IMG/btnRP.png"));

	// PINTING IMAGE
	ImageView imageViewP1 = new ImageView(new Image("IMG/ORASI.png"));
	ImageView imageViewP = new ImageView(new Image("IMG/comGG.png"));
	
	ImageView imageViewGIF = new ImageView(new Image("IMG/CANSAT.gif"));
...
//    Font Font1 = new Font("Cascadia Code",19);
	...
	ImageView imageViewConnect = new ImageView(new Image("IMG/btnCon.png"));
	ImageView imageViewDisconnect = new ImageView(new Image("IMG/btnDis.png"));
	ImageView imageViewSend = new ImageView(new Image("IMG/btnSend.png"));
	...
	// CRONÓMETROs
	clockGS cronus;
	public static Text txtClock = new Text("00:00:00");
	...
	public SF_mode(Pane root, int x, int y) {
		super(root, x, y);
		lobby2.play();
		...
		GPaneGif_1 = new GridPane();
		GPaneGif_2 = new GridPane();
		GPaneGif_3 = new GridPane();
		GPaneGif_4 = new GridPane();
		GPaneGif_5 = new GridPane();
		...
		GPane.createGrid(GPaneGif_1, x, y, 3, 1);
		GPane.createGrid(GPaneGif_2, x/3, y/2, 1, 1);
		GPane.createGrid(GPaneGif_3, x/3+80, y/2-40, 1, 1);
		...
		GPane.createGrid(GPane43, x * 0.23, y * 0.17, 1, 1);
		GPane.createGrid(GPane44, x * 0.23, y * 0.17, 4, 1);
		...
		cS.createText(Temperature, Color.WHITE, shadow1, x / 2, y / 2);

		Altitude = new Text("0.0\n  m");
		Altitude.setFont(Font.font("Consolas", FontWeight.BOLD, 15));
		cS.createText(Altitude, Color.WHITE, shadow1, x / 2, y / 2);
		Pressure = new Text("0.0\nKPa");
		Pressure.setFont(Font.font("Consolas", FontWeight.BOLD, 15));
		cS.createText(Pressure, Color.WHITE, shadow1, x / 2, y / 2);
		Acceleration = new Text(" 0.0\nm/s^2");
		Acceleration.setFont(Font.font("Consolas", FontWeight.BOLD, 15));
		cS.createText(Acceleration, Color.WHITE, shadow1, x / 2, y / 2);

		// POINTING
		Compass = new Text(" 0.0°");
		Compass.setFont(Font.font("Consolas", FontWeight.BOLD, 12));
		cS.createText(Compass, Color.WHITE, shadow1, x / 2, y / 2);
		// BATERIA
		Voltage = new Text("0.0V");
		Voltage.setFont(Font.font("Consolas", FontWeight.BOLD, 15));
		cS.createText(Voltage, Color.WHITE, shadow1, x / 2, y / 2);

		// Textos
		Tilt_X = new Text("0.00°");

		cS.createText(Tilt_X, Color.LIGHTBLUE, shadow1, x / 2, y / 2);
		Tilt_Y = new Text("0.00°");
		cS.createText(Tilt_Y, Color.LIGHTBLUE, shadow1, x / 2, y / 2);
		Gps_Time = new Text("00:00:00");
		cS.createText(Gps_Time, Color.LIGHTBLUE, shadow1, x / 2, y / 2);
		Gps_Altitude = new Text("0.0m");
		cS.createText(Gps_Altitude, Color.LIGHTBLUE, shadow1, x / 2, y / 2);
		Gps_Latitude = new Text("0.00000°N");
		cS.createText(Gps_Latitude, Color.LIGHTBLUE, shadow1, x / 2, y / 2);
		Gps_Longitude = new Text("0.00000 °W");
		cS.createText(Gps_Longitude, Color.LIGHTBLUE, shadow1, x / 2, y / 2);
		Gps_Sats = new Text("0");
		cS.createText(Gps_Sats, Color.LIGHTBLUE, shadow1, x / 2, y / 2);
		...
		// TIMEMISSION
		TM = new Text("00:00:00");
		TM.setFill(Color.WHITE);
		TM.setFont(new Font("Consolas", 53));
		TM.setEffect(shadow);

		DropShadow shG = new DropShadow();
		shG.setColor(Color.PINK);
		GPane0.add(GPaneGif_1, 0, 0);
		GPaneGif_1.add(GPaneGif_2, 0, 0);
		HBox hb_gif = new HBox();
		VBox vb_gif = new VBox();
		hb_gif.getChildren().add(GPaneGif_3);
		hb_gif.setAlignment(Pos.BOTTOM_RIGHT);
		vb_gif.getChildren().add(hb_gif);
		vb_gif.setAlignment(Pos.BOTTOM_RIGHT);
		GPaneGif_2.add(vb_gif, 0, 0);
		imageViewGIF.setX(0);
		imageViewGIF.setY(0);
		imageViewGIF.setFitWidth(y * 0.29);
		imageViewGIF.setPreserveRatio(true);
		imageViewGIF.setEffect(shG);
		imageViewGIF.setRotate(90);
		BorderPane bp_gif = new BorderPane();
		bp_gif.setCenter(imageViewGIF);
		GPaneGif_3.add(bp_gif, 0, 0);
...
//      BATERIA, posicionamiento
		cS.createRect(R1, GPane6, y * 0.058, x * 0.12, Color.rgb(32, 56, 100), Color.rgb(32, 56, 100), 0, 0);
		cS.createRect(R2, GPane6, y * 0.058, x * 0.00, Color.rgb(192, 240, 247), Color.rgb(192, 240, 247), 0, 0);
		cS.createCirc(C1, C2, C3, GPane7, VBC1, y * 0.021, x * 0.12, Color.rgb(32, 56, 100), Color.rgb(47, 82, 143), 3,
				0);
		cS.createCirc2(C4, C5, GPane8, VBC2, y * 0.021, x * 0.12, Color.rgb(32, 56, 100), Color.rgb(47, 82, 143), 1, 0);
		cS.createCirc3(CE1, GPane50, VBS1, y * 0.020, x * 0.12, Color.rgb(51, 63, 80), Color.rgb(242, 242, 242), 0, 0);
		cS.createCirc7(CE2, GPane50, VBS2, y * 0.020, x * 0.12, Color.rgb(51, 63, 80), Color.rgb(242, 242, 242), 0, 2);
		cS.createCirc4(CE3, GPane50, VBS3, y * 0.020, x * 0.12, Color.rgb(51, 63, 80), Color.rgb(242, 242, 242), 1, 3);
		cS.createCirc4(CE4, GPane50, VBS4, y * 0.020, x * 0.12, Color.rgb(51, 63, 80), Color.rgb(242, 242, 242), 3, 3);
		cS.createCirc5(CE5, GPane50, HBS1, y * 0.020, x * 0.12, Color.rgb(51, 63, 80), Color.rgb(242, 242, 242), 4, 2);
		cS.createCirc6(CE6, GPane50, HBS2, y * 0.020, x * 0.12, Color.rgb(51, 63, 80), Color.rgb(242, 242, 242), 4, 0);
		// MODE OF OPERATION - CHANGE OPERATION
		// ARC
		Group Gp1 = new Group();
		HBox HBgp1 = new HBox();
		cS.createArc(arc1, Color.TRANSPARENT, Color.rgb(45, 70, 84), 8, x / 2, y / 2, 44, 44, 300, 300, shadow);
		cS.createArc(arc2, Color.TRANSPARENT, Color.AQUA, 6, x / 2, y / 2, 44, 44, (-1) * 121, (-1) * 0, shadow);
		...
		Group Gp2 = new Group();
		HBox HBgp2 = new HBox();
		cS.createArc(arc3, Color.TRANSPARENT, Color.rgb(45, 70, 84), 8, x / 2, y / 2, 44, 44, 300, 300, shadow);
		cS.createArc(arc4, Color.TRANSPARENT, Color.AQUA, 6, x / 2, y / 2, 44, 44, (-1) * 121, (-1) * 0, shadow);
		...
		Group Gp3 = new Group();
		HBox HBgp3 = new HBox();
		cS.createArc(arc5, Color.TRANSPARENT, Color.rgb(45, 70, 84), 8, x / 2, y / 2, 44, 44, 300, 300, shadow);
		cS.createArc(arc6, Color.TRANSPARENT, Color.AQUA, 6, x / 2, y / 2, 44, 44, (-1) * 121, (-1) * 0, shadow);
		...
		Group Gp4 = new Group();
		HBox HBgp4 = new HBox();
		cS.createArc(arc7, Color.TRANSPARENT, Color.rgb(45, 70, 84), 8, x / 2, y / 2, 44, 44, 300, 300, shadow);
		cS.createArc(arc8, Color.TRANSPARENT, Color.AQUA, 6, x / 2, y / 2, 44, 44, (-1) * 121, (-1) * 0, shadow);
...
//            	System.exit(0);
		...
		RS_1.setFill(Color.rgb(180, 199, 231)); 
		...
		RS_1_2.setFill(Color.rgb(180, 199, 231)); 
		...
		RS_2.setFill(Color.rgb(180, 199, 231)); 
		...
		RS_2_1.setFill(Color.rgb(180, 199, 231));
		...
		RSB_1_2.setFill(Color.rgb(180, 199, 231)); 
		...
		RSB_1_2_3.setFill(Color.rgb(180, 199, 231)); 
		...
		RSB_1_2_3_4.setFill(Color.rgb(180, 199, 231)); 
...
//        GPane48.setGridLinesVisible(true);
		...
		GPaneGif_1.getStyleClass().add("mygridStyle");
		GPaneGif_2.getStyleClass().add("mygridStyle");
		GPaneGif_3.getStyleClass().add("mygridStyle");
		GPaneGif_4.getStyleClass().add("mygridStyle");
        ...
        cbX2.addEventHandler(MouseEvent.MOUSE_CLICKED,
		           new EventHandler<MouseEvent>() {
			           @Override
			           public void handle(MouseEvent e) {
			   				cbxS.play();
	...
	private void startThrearCronus() {
		if (startThread = true) {
...
//				threadClock.start();
	...
	private void TaskCanSatStandBy(String data1) {
		...
		if(data1.equals("LAUNCH-WAIT") && (!data1.equals("MAST RAISED") ||
			...
			C1.setFill(Color.LIME);
				 ...
				 !data1.equals("ASCENT") || !data1.equals("ROCKET SEPARATION") ||
				 !data1.equals("AEROBRAKING RELEASE")){
			C1.setFill(Color.rgb(32, 56, 100));
		}
	}
	...
	private void TaskCanSatGPS(String data1) {
		...
		if(data1.equals("YES")) {
			C2.setFill(Color.rgb(0,176,240));
		}else {
			C2.setFill(Color.rgb(32, 56, 100));
		}
	}
	...
	private void TaskCanSatCamera(String data1) {
		...
		if(data1.equals("ON")) {
			C3.setFill(Color.rgb(0,176,240));
		}else {
			C3.setFill(Color.rgb(32, 56, 100));
		}
	}
	
	private void TaskCanSatFlagRaised(String data1) {
		if(data1.equals("M")) {
			C4.setFill(Color.rgb(0,176,240));
		}else {
			C4.setFill(Color.rgb(32, 56, 100));
		}
	}
	...
	private void TaskCanSatAerobraking(String data1) {
		...
		if(data1.equals("P")) {
			C5.setFill(Color.rgb(0,176,240));
		}else {
			C5.setFill(Color.rgb(32, 56, 100));
		}
	}
	/*
	 * 
...
//            s.setStroke(Color.ALICEBLUE);
	...
	private void Anim_Battery(double data, Rectangle R, double WR) {
	...
	public void Anim_Batt(double batt, Rectangle R, double WR) {
		R.setWidth((batt*(WR))/9);
	}
	...
	private void StateCanSat(String data, Circle CE1, Rectangle RS_1, Circle CE2, Rectangle RS_2, Rectangle RSB_1_2, Circle CE3, Rectangle RSB_1_2_3, Circle CE4, Rectangle RSB_1_2_3_4, Circle CE5, Rectangle RS_2_1, Circle CE6, Rectangle RS_1_2) {
		
		DropShadow sh = new DropShadow();
		sh.setColor(Color.WHITE);
		
		if(data.equals("LAUNCH-WAIT")) {
			CE1.setFill(Color.rgb(0, 176, 240));
			CE1.setStroke(Color.rgb(242, 242, 242));
			CE1.setEffect(sh);
			RS_1.setFill(Color.rgb(0, 176, 240));
			RS_1.setStroke(Color.rgb(242, 242, 242));
			RS_1.setEffect(sh);
			...
			RS_1.setStroke(Color.rgb(242, 242, 242));
			RS_1.setEffect(sh);
			CE2.setFill(Color.rgb(0, 176, 240));
			CE2.setStroke(Color.rgb(242, 242, 242));
			CE2.setEffect(sh);
			RS_2.setFill(Color.rgb(0, 176, 240));
			RS_2.setStroke(Color.rgb(242, 242, 242));
			RS_2.setEffect(sh);
			RSB_1_2.setFill(Color.rgb(0, 176, 240));
			RSB_1_2.setStroke(Color.rgb(242, 242, 242));
			...
			RSB_1_2.setStroke(Color.rgb(242, 242, 242));
			RSB_1_2.setEffect(sh);
			CE3.setFill(Color.rgb(0, 176, 240));
			CE3.setStroke(Color.rgb(242, 242, 242));
			CE3.setEffect(sh);
			RSB_1_2_3.setFill(Color.rgb(0, 176, 240));
			RSB_1_2_3.setStroke(Color.rgb(242, 242, 242));
			...
			RSB_1_2_3.setStroke(Color.rgb(242, 242, 242));
			RSB_1_2_3.setEffect(sh);
			CE4.setFill(Color.rgb(0, 176, 240));
			CE4.setStroke(Color.rgb(242, 242, 242));
			CE4.setEffect(sh);
			RSB_1_2_3_4.setFill(Color.rgb(0, 176, 240));
			RSB_1_2_3_4.setStroke(Color.rgb(242, 242, 242));
			...
			RSB_1_2_3_4.setStroke(Color.rgb(242, 242, 242));
			RSB_1_2_3_4.setEffect(sh);
			CE5.setFill(Color.rgb(0, 176, 240));
			CE5.setStroke(Color.rgb(242, 242, 242));
			CE5.setEffect(sh);
			RS_2_1.setFill(Color.rgb(0, 176, 240));
			RS_2_1.setStroke(Color.rgb(242, 242, 242));
			RS_2_1.setEffect(sh);
			...
			RS_2_1.setStroke(Color.rgb(242, 242, 242));
			RS_2_1.setEffect(sh);
			CE6.setFill(Color.rgb(0, 176, 240));
			CE6.setStroke(Color.rgb(242, 242, 242));
			CE6.setEffect(sh);
			RS_1_2.setFill(Color.rgb(0, 176, 240));
			RS_1_2.setStroke(Color.rgb(242, 242, 242));
			RS_1_2.setEffect(sh);
		}
